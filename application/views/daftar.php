                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('daftar/del/') . $row->id_bayar ?>"
                                class="btn btn-sm btn-danger btn-sm" onclick="return confirm('Yakin akan dihapus ?')">
                                <i class="fa-regular fa-trash-can"></i> Del</a>
                            <a href="<?= base_url('daftar/kirim/') . $row->id_bayar ?>"
                                class="btn btn-sm btn-primary btn-sm"><i class="fa-solid fa-paper-plane"></i> Kirim</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
